...
Todos los gotchas, errores comunes y comportamientos inesperados documentados para desarrolladores.
...
### 7. Precios SIEMPRE en centavos en backend
...
> **Trampa:** Si ves `price: 12550` en un response y lo mostras directo, el usuario ve "$12,550" en vez de "$125.50".

### 8. IDs: BigInteger en backend, string en frontend

| Capa | Tipo | Ejemplo |
|------|------|---------|
| Backend (BD, API) | `int` / `BigInteger` | `42` |
| Frontend (stores, UI) | `string` | `"42"` |
| Frontend (IDs locales) | `string` (UUID) | `"a1b2c3d4-..."` |
...
### 9. Session status: UPPERCASE en backend, lowercase en frontend
...
### 10. Branch slugs son globalmente unicos
...
### 11. NUNCA destructurar el store
...
### 12. useShallow obligatorio para arrays filtrados/computados
...
### 13. EMPTY_ARRAY constante para fallbacks
...
### 14. logout() debe deshabilitar retry en 401
...
### 15. WebSocket token va en query param, no en header
...
### 16. No hay migracion "initial schema"
...
### 19. Hook mount guard obligatorio
...
### 20. WebSocket listener con useRef
...
### 21. Boolean comparison con .is_(True)
...
### 22. Tabla "Check" usa nombre custom
