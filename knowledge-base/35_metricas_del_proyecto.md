...
| Documentos Knowledge Base | 27 → 35 (esta expansion) |
...
|----------|---------|-----------|
| CI | ci.yml | Tests, lint, type-check en cada PR |
| Docker Build | docker-build.yml | Build y push de imagenes Docker |
...
| Stores/pagina | 0.85 | 3.67 | 1.0 |
| Hooks/componente | 0.50 | 0.48 | 0.27 |

### Observaciones de los ratios

- **Dashboard** es la app mas compleja en terminos de paginas (26) y stores (22), coherente con su rol de panel de administracion multi-entidad.
